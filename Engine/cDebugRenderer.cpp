...
bool cDebugRenderer::Initialize()
{
    ...
    {
        glm::vec3 lineStart = glm::vec3(MathUtils::GetRandomFloat(-MAX_LINE_POSITION, MAX_LINE_POSITION),
            MathUtils::GetRandomFloat(-MAX_LINE_POSITION, MAX_LINE_POSITION),
            MathUtils::GetRandomFloat(-MAX_LINE_POSITION, MAX_LINE_POSITION));

        glm::vec3 lineEnd = glm::vec3(MathUtils::GetRandomFloat(-MAX_LINE_POSITION, MAX_LINE_POSITION),
            MathUtils::GetRandomFloat(-MAX_LINE_POSITION, MAX_LINE_POSITION),
            MathUtils::GetRandomFloat(-MAX_LINE_POSITION, MAX_LINE_POSITION));

        glm::vec4 lineColour = glm::vec4(MathUtils::GetRandomFloat(0.0f, 1.0f),
            MathUtils::GetRandomFloat(0.0f, 1.0f),
            MathUtils::GetRandomFloat(0.0f, 1.0f),
            1.0f);
    ...
    cDebugRenderer_pMeshManager->LoadModelIntoVAO("Sphere_1_unit_Radius_xyz_n_rgba_uv.ply", sphereMeshInfo, debugShaderProgramID);
