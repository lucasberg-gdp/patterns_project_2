...
//	glm::vec3 orientation = glm::vec3(0.0f);
	...
	{
		m_oldOrientation = m_qOrientation;
		m_qOrientation = glm::normalize(rotation);
		eulerOrientation = glm::eulerAngles(m_qOrientation);
	}
...
public:
	...
	void AssociateMesh(iPhysicsMeshTransformAccess* mesh);
