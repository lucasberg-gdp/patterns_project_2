...
//cMesh* findObjectByFriendlyName(std::string friendlyName);
...
//	for (unsigned int meshIndex = 0; meshIndex != g_pPhysics->m_vec_pPhysicalProps.size(); meshIndex++)
//	{
//		sPhysicsProperties* pCurrentPhysObject = g_pPhysics->findShapeByVectorID(meshIndex);
//
