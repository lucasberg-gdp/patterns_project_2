...
//		glm::vec3 target_or_at_vector;
//		glm::vec3 position_or_eye_vector;
//		glm::vec3 up_vector;
//		std::string name;
//	};
//
...
//		glm::vec3 colour_ambient_RGB;
//		glm::vec3 colour_diffuse_RGB;
//		glm::vec3 colour_specular_RGB;
//		glm::vec3 position;
//		glm::vec3 direction;
//		std::string name;
//		enum eLightType
...
//		{
//			std::string name;
//			std::vector<glm::vec3> vecUVs;
//		};
//		std::vector< sUVChannel > vecTextureChannels;
//		std::vector<unsigned int> vecIndices;
//
//		std::vector<cFace> vecFaces;
//		std::vector<cBone> vecBones;
//
//		enum ePrimitiveType
//		{
...
//		std::string getPrimitiveTypeString(void);
//
//
...
//		//		std::map< std::string /*scene name*/, AH::cScene* > map_Scenes_by_filename;
//
//				// Returns NULL of no file of that name was loaded
//				// Pointer is still owned by the file loader (so don't delete it)
//		cScene* getModelFileOrScenePointer(std::string filename);
//		// reutrns false if that file hasn't been loaded
//		bool cloneModelFileOrScene(std::string filename, cScene& theScene);
//
//
...
////namespace AH
////{
////	struct ASSIMP_HELPER_LIBRARY AH_sVec3
////	{
////		float x = 0.0f;
////		float y = 0.0f;
////		float z = 0.0f;
////	};
////	struct ASSIMP_HELPER_LIBRARY AH_sColourRGB
////	{
////		float r = 0.0f;
////		float g = 0.0f;
////		float b = 0.0f;
////	};
////	struct ASSIMP_HELPER_LIBRARY AH_sColourRGBA
////	{
////		float r = 0.0f;
////		float g = 0.0f;
////		float b = 0.0f;
...
//
//
////	class ASSIMP_HELPER_LIBRARY AH_cMesh
////	{
////	public:
////		AH_cMesh() {};
////		AH_cString name;
////		AH_sVec3* vertices = NULL;
////		AH_sVec3* normals = NULL;
////		AH_sVec3* tangents = NULL;
////		AH_sVec3* bitangents = NULL;
////		AH_sColourRGBA* coloursRGBA = NULL;
////		AH_sVec3* texture_coordinates = NULL;
...
////		};
////		ePrimitiveType primitive_type = UNKNOWN_OR_UNDEFINED;
////		AH_cString getPrimitiveTypeString(void);
////
////		unsigned int GetNumColorChannels();	// Get the number of vertex color channels the mesh contains.
////		unsigned int GetNumUVChannels();	// Get the number of UV channels the mesh contains.
////		bool HasBones();					// Check whether the mesh contains bones.
...
////	};//cMesh
//
////	class ASSIMP_HELPER_LIBRARY AH_cScene
////	{
////	public:
////		AH_cScene();
////
